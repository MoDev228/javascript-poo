...
En JavaScript, une variable qui contient un objet ne contient pas une copie indépendante de toutes les données de l'objet. Elle contient une **référence vers l'objet**.
...
## 3. Une vraie copie superficielle avec le spread operator
